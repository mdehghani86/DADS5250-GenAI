...
| 5 | Embeddings gap (M01, M05, M10). | DeepSeek and Z.ai intl have no embeddings endpoint. | Qwen as second key (phase 2); local sentence-transformers fallback still open. | M05 RAG runs for a restricted student. | Planned (phase 2). |
