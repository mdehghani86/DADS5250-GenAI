window.QUIZ = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "type": "mc",
      "typeLabel": "Coding",
      "prompt": "In a ReAct-style agent, what happens in code on each pass of the loop?",
      "code": "while not done:\n    thought, action = model.decide(state)\n    observation = run_tool(action)\n    state = state + observation",
      "options": [
        {
          "letter": "A",
          "text": "The model reasons and picks a tool, your code runs it and feeds the observation back, and the loop repeats until the task is done.",
          "explanation": "Correct: reason, act, observe, repeat, which is the ReAct loop."
        },
        {
          "letter": "B",
          "text": "The model returns the final answer on the first pass, so there is no loop.",
          "explanation": "That is a single call, not an agent. The agent reasons and acts repeatedly until it can answer."
        },
        {
          "letter": "C",
          "text": "Every tool is called at once in parallel and the results are averaged.",
          "explanation": "The agent chooses one action per step from its reasoning; it does not fire all tools and average them."
        },
        {
          "letter": "D",
          "text": "The loop always runs a fixed number of times set in advance.",
          "explanation": "It continues until the agent decides the task is complete, not for a preset count."
        }
      ],
      "correctIndex": 0
    }
